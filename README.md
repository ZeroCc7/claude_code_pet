...
- 自动前进每 3 秒消耗 1 灵力，事件选择期间暂停。
- 事件中 K2 / K3 切换选项，K1 确认，K4 放弃并结束本次历练。
...
- 法诀和相关事件会增加灵修倾向。
- 稳健倾向降低受伤并提高闪避率。
- 亲和倾向影响友善事件，并可能在战斗回合中恢复体力。

状态页会显示当前形态、等级、下一阶段和四类倾向。

经验来源：

- 青云山道事件：按选择结果获得经验、灵石、物品或进度。
- 青云妖狼首次胜利：30 经验、25 灵石。
- AI 成功任务：每分钟 2 经验，最少按 1 分钟、最多按 30 分钟。
